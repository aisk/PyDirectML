...
class CompiledOperator:
    ...
    # Attached by the wrapper layer:
    def initialize(self, weights: dict[Expression, _Array]) -> None: ...
    def dispatch(self, inputs: Optional[dict[Expression, _Array]] = ...) -> list[np.ndarray]: ...
    def __call__(self, inputs: Optional[dict[Expression, _Array]] = ...) -> list[np.ndarray]: ...
...
class Graph:
    ...
    def input(self, sizes: Optional[_Shape] = ..., dtype: Optional[_DtypeLike] = ...,
              *, owned: bool = ..., strides: _Strides = ...,
              desc: Optional[TensorDesc] = ...) -> Expression: ...
...
def reinterpret(input: Expression, sizes: Sequence[int],
                strides: _Strides = ...,
                dtype: Optional[TensorDataType] = ...) -> Expression: ...
